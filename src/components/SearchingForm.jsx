  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-8">
      ...
      <div className="relative flex">
        ...
        <button 
          type="submit"  
          className="ml-2 text-white bg-[#4B0082]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  hover:opacity-75 dark:focus:ring-blue-800">
          Search
        </button>
      </div>
    </form>
